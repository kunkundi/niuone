...
class DashboardAuthTests(unittest.TestCase):
    ...
    def test_frontend_pages_and_assets_are_served_from_native_static_files(self):
        ...
        self.assertIn('<link rel="stylesheet" href="/static/dashboard.css?v=39">', DASHBOARD_FRONTEND)
        self.assertIn('<script src="/static/dashboard.js?v=47" defer></script>', DASHBOARD_FRONTEND)
